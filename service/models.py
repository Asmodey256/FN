...
class Maintenance(models.Model):
    ...
    service_company = models.ForeignKey(to='service.ServiceCompany', on_delete=models.CASCADE, verbose_name='Организация, проводившая ТО', null=True, blank=True)
...
class Complaint(models.Model):
    ...
    car = models.ForeignKey(Car, on_delete=models.CASCADE, verbose_name='Машина')
    service_company = models.ForeignKey(to='service.ServiceCompany', on_delete=models.CASCADE, verbose_name='Сервисная компания', null=True, blank=True)
